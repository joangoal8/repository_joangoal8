...
public class MainApp {
	...
	public static final Integer numEndPoints=10;
	public static final Integer numRequests=100;
	...
	public static void main(String[] args) {
		...
		try {
			FileInputStream fileIn = new FileInputStream("resources/me_at_the_zoo.in");
		...
		System.out.println("LLista Original Videos =" + llistaEndPoints.toString());
		System.out.println("LLista Original Videos =" + llistaRequest.toString());
